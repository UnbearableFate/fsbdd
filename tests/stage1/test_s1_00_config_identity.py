...
def valid_config() -> dict[str, object]:
    return {
        ...
        "algorithm": {"S_max": 0, "lambda_s": 1.0, "Q": 8, "Q_fresh": 8, "grace_seconds": 0.0},
...
def test_required_fields_unknown_fields_and_frozen_digest(tmp_path: Path) -> None:
    ...
    for section, field in [
        ("algorithm", "S_max"), ("algorithm", "Q"), ("algorithm", "Q_fresh"),
        ("schedule", "H"), ("schedule", "offsets"), ("model", "repository"),
        ("data", "repository"), ("storage", "root"), ("stop", "target_global_cycles"),
        ("run", "seed"),
    ]:
...
def test_progress_dimensions_are_not_collapsed() -> None:
    snapshot = ProgressSnapshot(
        learner_local_steps={"learner-0": 10}, learner_tokens={"learner-0": 2048},
        fragment_outer_updates={"fragment-0": 2}, global_cycle=2,
        fragment_accepted_tokens={"fragment-0": 1024}, fresh_accepted=1, stale_accepted=0,
    )
