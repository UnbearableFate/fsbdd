    ...
    def update_learner(
        ...
        *,
        ...
        if (
            ...
            or current.loss_bearing_target_tokens
            < previous.loss_bearing_target_tokens
        ):
    ...
    def record_fragment_commit(
        ...
        *,
        ...
        self._fragments[index] = FragmentProgressRecord(
            ...
            + _positive(
                fresh_accepted_contributions, "fresh accepted contributions"
            ),
            stale_accepted_contributions=previous.stale_accepted_contributions
            + _ordinal(
                stale_accepted_contributions, "stale accepted contributions"
            ),
        )
...
class FrozenStopPolicy:
    ...
    def identity(self) -> str:
        return canonical_digest(
            {"schema_version": 1, **dataclasses.asdict(self)}
        )
