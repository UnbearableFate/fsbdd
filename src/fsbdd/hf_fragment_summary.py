...
from .fragment_map import FragmentMapError, build_fragment_map
from .identity import canonical_digest
from .model_registry import RegistryError, build_logical_layer_registry


def summarize(model_repository: str, revision: str, fragment_count: int, output: Path) -> dict[str, Any]:
